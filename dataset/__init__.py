...
from dataset.pretrain_dataset import build_tokenizer, ImageTextJsonDataset, RegionTextJsonDataset
...
def create_dataset(dataset, config):
    ...
    elif dataset == 'infer_caption':
        return infer_caption_dataset(test_transform, config['img_rdir'])
