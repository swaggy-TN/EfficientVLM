...
class NLVRL0Module(Module):
    def __init__(self,
        ...
        super(NLVRL0Module, self).__init__()
        ...
        num_text_layers = text_config.fusion_layer
        num_cross_layers = text_config.num_hidden_layers - text_config.fusion_layer
        text_config.num_hidden_layers = num_text_layers + 2 * num_cross_layers
        vision_config = read_json(config['vision_config'])
        assert config['patch_size'] == vision_config['patch_size']
        self.all_types = ["vision_intermediate_z", "vision_head_z","text_intermediate_z", "text_head_z","cross_intermediate_z", "cross_head_z"]
        ...
        assert self.cross_num_hidden_layers == 6
    ...
    def calculate_model_size(self, zs):
        ...
        head_nums = sum(remaining_cross_head_nums) +sum(remaining_text_head_nums) + sum(remaining_vision_head_nums)

        intermediate_nums = sum(remaining_vision_intermediate_nums) + sum(remaining_text_intermediate_nums) + sum(remaining_cross_intermediate_nums)
